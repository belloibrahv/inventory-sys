...
const children = [
  ...
  new Table({
    ...
    rows: [
      ...
      ["Version", "1.31"],
      ["Status", "Updated: supplier bill item search, condition, and storage"],
    ].map(([k, v]) =>
      new TableRow({
        children: [
...
h1("5. Words we use"),
  ...
  ...feature({
    title: "10.26 Reports",
    what: "Reports shows sales, money collected from cash plus transfer plus POS, stock value, Swap Deal value, returns, and who still owes, for the period you pick: one day, the last 7 days, or this month so far. Last period sits beside this period so you can see movement. Click a box to download those rows. Print or download gives a branded management report. Opening stock is its own value, apart from later unpaid supplier bills. The pack does not change any invoice.",
    why: "Home is a snapshot. Reports is the pack you take to a meeting. It must look like a company paper, not a screen dump with buttons. Loading every sale the shops ever made would freeze the page, so the pack now reads one stretch of days.",
    story: "Friday review. The CEO opens Reports, picks This month so far, then Last 7 days to compare the week. Iwo Road and Challenge sit on one page. Low stock is listed. The Check the books button is not on the paper. Nobody copies numbers from a notebook.",
    steps: [
      "Sign in as CEO.",
      "Click Reports.",
  ...
  ...feature({
    ...
    steps: [
      ...
      "On Supplier bill: pick the shop and the supplier.",
      "Under What is on this bill, type the product name in the search bar and pick it. Only the name fills the item column.",
      "Pick condition, pick storage, type cost and how many, then scan each IMEI. Save.",
      ...
      "On One phone at a time: scan one IMEI already in your hand with no bill.",
