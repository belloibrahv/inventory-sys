...
const children = [
  ...
  new Table({
    ...
    rows: [
      ...
      ["Version", "1.35"],
      ["Status", "Updated: opening cash and named bank accounts on Money in and out"],
    ].map(([k, v]) =>
      new TableRow({
        children: [
...
h1("5. Words we use"),
  ...
  ...feature({
    ...
    what: "Suppliers is the list of people and companies you buy from. Each house has one name and one phone. Four boxes sit at the top: how many houses, what we bought, what we paid, and what we still owe. Click a box to see the houses that make that number. The list shows one summary row per house. Click IRIS, or any house, and the bills drop down with their values. Copies of the same name are folded into that one row. The system refuses a new copy, including extra spaces, capital letters, Ltd on the end, or a phone that already belongs to another house.",
    why: "You need one name for each source so money owed to them is clear. Two spellings of the same supplier split the bills and hide what you still owe. Showing every copy and every bill at once makes the page too long to read.",
    story: "Iwo Road opens Suppliers and sees IRIS as one row, not a pile of lines. They click We still owe. Only IRIS stays. They click IRIS and the unpaid bill drops down with the naira. IDAL, which had been typed four times, sits as one house. Click IDAL and the copies and the paid bills are there.",
    steps: [
      "Click Suppliers.",
      "Read the four boxes at the top. Click We still owe. The list shows only houses with money still owed.",
      "Click Suppliers on the books to see every house again.",
      "Click a house name such as IRIS. The bills drop down. Each bill has bought, paid, still owed, and status.",
    ...
    expect: [
      "Each of the four boxes is clickable and shows the houses that make that number.",
  ...
  bullet("On Reports, Still owed to suppliers shows the house name and the amount. Click the house to open its bills."),
