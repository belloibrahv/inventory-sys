...
const children = [
  ...
  new Table({
    ...
    rows: [
      ...
      ["Version", "1.60"],
      ["Status", "Updated: Sell now Amount paid always matches the sale total for Cash or Bank"],
    ].map(([k, v]) =>
      new TableRow({
        children: [
...
h1("5. Words we use"),
  ...
  ...feature({
    what: "Sell now is the till. There is one box: Scan or type to add to this sale. Use it for IMEI, serial, phone name, brand, category, storage, pouch, or charger cord. Phones and piece items share that same box. Phones with IMEI or serial stay one unit each. Piece items show a Pieces box on the sale line so you sell as many as you have on hand. Each phone line shows storage and How the phone looks under the name. The uploaded initial sell price is the floor (often for wholesale). You may raise it for a walk-in buyer. You cannot go under it unless the CEO or Super Admin overrides. Payment is Cash or Bank only. Bank means the full amount landed in one named bank account from Money in and out. Transfer, POS terminal, and USSD all count as Bank. There is no split payment.",
    why: "Two boxes on the till slow staff down, especially when light is low or a USB scanner is in use. One clear box for every item keeps the counter fast. Wholesale and walk-in buyers often pay different amounts for the same phone, so the floor and Cash or Bank rules stay.",
    story: "Monday at Iwo Road. The cashier scans a Camon 30 IMEI in the one box. Later a buyer wants a pouch. The cashier types pouch in the same box, taps the match, sets Pieces to 2, and finishes with cash. There was no second find field to hunt for.",
    steps: [
      ...
      "Pick Cash or Bank. If Bank, pick the shop bank account that received the full amount. Finish.",
    ],
    expect: [
      ...
      "Piece items have an editable Pieces box. IMEI lines stay at 1.",
      ...
      "Bank sales require a named bank account. Money in and out shows sales into that account.",
  ...
  table(
    ...
    [
      ...
      ["54", "Credit sale with a bank deposit", "cashier@abutwins.com", "Sell 180,000. Pick Credit sales. Type 120,000 received now. Pick Bank and the shop bank account. Complete sale. Check the books shows Bank received 120,000 and Credit sales 60,000."],
      ...
      ["81", "Sell piece items by quantity", "cashier@abutwins.com", "Find a pouch or charger cord. Add it. Type 3 in Pieces. Complete sale. Shop stock drops by 3. An IMEI phone line stays at 1 piece."],
      ["82", "Cash or Bank on Sell now with named account", "cashier@abutwins.com", "How they paid shows Cash, Bank, Credit sales only. Bank sale picks GTBank or another named account. Money in and out shows Sales into this account for that bank. Split payment is not offered."],
  ...
  bullet("Piece items such as pouches and charger cords sell by Pieces on Sell now, up to on hand. Phones and laptops with IMEI or serial stay one unit each."),
