...
const children = [
  ...
  new Table({
    ...
    rows: [
      ...
      ["Version", "1.39"],
      ["Status", "Updated: second content pass. Goods on the way, Shop to shop, Stock count, and Check the books use shop words"],
    ].map(([k, v]) =>
      new TableRow({
        children: [
  ...
  body("This release also makes everyday words clearer for the till. Trade-In and Exchange is now Swap Deal on the left menu. Profit shows each phone with its storage and condition, the cost price, and a button to extract the list. Cashiers can open Money in and out and Customers and money owed so they can follow people who bought on credit. When you put a phone on the shelf, How the phone looks uses Brand new, Uk, OPENBOX, Faulty, and Non Active, you can add a new supplier on the spot, and battery health is no longer asked."),
  ...
  body("Correct and close opening stock now shows each item's category. You can tap Phones, Accessories, Screen, or Laptop so different people can count different groups at the same time."),
  body("Close the day is more flexible for shops that sell mostly by transfer and POS. Cash remittance is required only when cash came into the till. Transfer and POS days still close so Sell now can open the next day, but with no till count. The Financial Accountant and records checker can open every shop page to oversee the business. They can post money. They cannot sell, open repairs, load stock, approve shop work, or change Who can see what."),
  ...
  body("On Sell now, credit sales can still take money today. The cashier types the amount received now and says if it was cash, transfer, or POS. Check the books then shows that deposit in the right box, and Credit sales as only what is still owed."),
  body("The leftover office words on the left menu, Home, Shop stock, Money in and out, Reports, Check the books, and Who can see what are now shop words. Staff see Home, Sell now, Close the day, Shop stock, Cost, and Sell price, not Point of Sale, SKU, or Cost Basis. How the phone looks stays Brand new, Uk, OPENBOX, Faulty, and Non Active."),
...
h1("5. Words we use"),
  ...
  table(
    ...
    [
      ...
      ["How the phone looks", "Brand new, Uk, OPENBOX, Faulty, or Non Active when a phone is booked in."],
      ["Item name", "The product name only, on a supplier bill. Type it, pick it, then fill condition and storage beside it. Do not glue storage or condition onto the name."],
  ...
  table(
    ...
    [
      ...
      ["Records checker", "Internal check person", "See every shop page. Check the books. Post money. Cannot sell, open repairs, load stock, or change Who can see what."],
      ["Accountant", "Accounts", "See every shop page. Check the books. Record pay-outs. Cannot sell, open repairs, load stock, or change Who can see what."],
  ...
  table(
    ...
    [
      ...
      ["Sell & buy", "Sales, Sell now, Close the day, Goods from supplier, Customers & money owed, Suppliers", "Sell, count the till, print invoices, buy from a supplier, see who still owes us, keep people lists."],
      ["Daily work", "Shop to shop, Neighbor shop fill, Returns, Swap Deal, Repairs, Stock count", "Move our stock, fill from next door, take phones back, swap, fix, count shelves."],
  ...
  ...feature({
    ...
    steps: [
      ...
      "To put a phone already in your hands on the shelf, open Stock intake. Pick the item with its storage and condition. Pick How the phone looks: Brand new, Uk, OPENBOX, Faulty, or Non Active. Pick a supplier, or choose Add new supplier. Do not look for battery health. It is not on this form.",
    ],
    expect: [
      ...
      "How the phone looks uses Brand new, Uk, OPENBOX, Faulty, and Non Active.",
  ...
  ...feature({
    title: "10.6 Sell now",
    what: "Sell now is the till. You scan or search a phone number or an item name, put it on this sale, pick the buyer, pick cash, transfer, POS, split, or credit sales, collect money, and finish. Each scanned phone shows storage and How the phone looks (Brand new, Uk, OPENBOX, Faulty, or Non Active). Credit sales can still take a deposit today: type the amount received now and say if it was cash, transfer, or POS. What is left is credit sales. The system then makes an invoice and clears the till for the next buyer. A USB scanner works like a keyboard: scan, then Enter. The till does not load every phone in the shop. Scan the full IMEI and the system finds that one phone. A phone camera can read the barcode if the browser allows it. If yesterday had sales and nobody closed that day, Complete sale stays locked for everyone, including Super Admin, until the till is counted. If the line drops and the till is not locked, the sale stays on this device as a parked sale and posts when the line returns. After you have opened Sell now on that phone, a refresh is safe, and you can still scan from the last In shop list saved on that phone.",
    ...
    steps: [
      ...
      "Scan an In shop IMEI, or type it and press Enter. Add it. You should see storage and How the phone looks on that line.",
      ...
      "Set the amount paid and the method. For credit sales, type any deposit received now and how they paid it, then finish.",
      "If the line is down and the till is not locked, finish anyway. You should see that the sale is saved on this device.",
      "While the line is down, scan an IMEI that was In shop when you last opened Sell now. It should add to this sale.",
    ...
    expect: [
      ...
      "A phone already on this sale cannot be added twice.",
      "The scanned line shows storage and How the phone looks from intake.",
      ...
      "A 180,000 naira credit sale with 120,000 transfer received now leaves 60,000 credit. Transfer received on Check the books shows 120,000.",
  ...
  ...feature({
    ...
    what: "Customers & money owed is the list of buyers. You keep a name and a phone. Tap Still owing to see who bought on credit and still needs to pay. A sale can start as walk-in, but a return needs a real name first.",
    why: "Warranty and refunds need a person you can call. A nameless sale cannot be returned safely. Cashiers also use this list to remind people who still owe Abu Twins.",
    story: "A Challenge cashier opens Customers & money owed, taps Still owing, and calls two buyers who took phones on credit last week. Later a walk-in wants a return. The cashier attaches the real name and phone, then starts the return.",
    steps: [
  ...
  ...feature({
    ...
    what: "Suppliers is the list of people and companies you buy from. Each house has one name and one phone. Boxes sit at the top: how many houses, what we bought, what we paid, what we still owe, and what they owe us after send-backs. Click a box to see the houses that make that number. The list shows one summary row per house. Click IRIS, or any house, and the bills drop down with their values. Copies of the same name are folded into that one row. The system refuses a new copy, including extra spaces, capital letters, Ltd on the end, or a phone that already belongs to another house.",
    why: "You need one name for each source so money owed to them, and money they owe you after phones go back, is clear. Two spellings of the same supplier split the bills and hide the true balance. Showing every copy and every bill at once makes the page too long to read.",
    story: "Iwo Road opens Suppliers and sees IRIS as one row, not a pile of lines. They click We still owe. Only IRIS stays. They click IRIS and the unpaid bill drops down with the naira. After they send five faulty phones back, They owe us shows if the send-back was more than the unpaid bill. IDAL, which had been typed four times, sits as one house. Click IDAL and the copies and the paid bills are there.",
    steps: [
      "Click Suppliers.",
      "Read the boxes at the top. Click We still owe. The list shows only houses with money still owed.",
      "Click They owe us to see houses with a surplus after send-backs.",
      "Click Suppliers on the books to see every house again.",
      "Click a house name such as IRIS. The bills drop down. Each bill has bought, paid, sent back, balance, and status.",
      ...
      "If it is a new house, type the name, the phone, and where they ship from, then save.",
    ],
    expect: [
  ...
  ...feature({
    ...
    expect: [
      ...
      "Stage chips say Waiting to send, On the way, and Received.",
      "The receiving shop taps Confirm they arrived.",
  ...
  ...feature({
    ...
    expect: [
      "Collect from next door. Complete this sale. Then Pay this neighbor.",
  ...
  ...feature({
    title: "10.13 Profit",
    what: "Profit shows what we sold from our own stock, what we kept on neighbor fills, and what is left after approved shop bills. Each sold phone line shows the name with storage and condition, the cost price, the sell price, and the profit. You can extract the list into Excel.",
    ...
    expect: [
      ...
      "Neighbor fill invoices do not also inflate own-stock profit.",
    ],
  }),
  ...
  ...feature({
    title: "10.15 Swap Deal",
    what: "A Swap Deal is when a customer brings an old phone and takes another. You type or scan the shop phone IMEI going out. You agree a swap value. A manager approves. You give the new phone, collect or pay the difference, and print an invoice. Tap Waiting, Approved, or Done to cut the list. Each card shows when it started or finished in Lagos time.",
    why: "Swap Deals mix stock and money. If they stay in chat, the old phone disappears and the new phone is not paid for.",
    story: "A customer swaps an iPhone 13 for an iPhone 15. The manager agrees the swap value. The customer pays the difference. The old phone is now shop stock. The new phone is sold on a new invoice.",
    steps: [
      "Click Swap Deal.",
      "Enter the customer device IMEI and scan the shop phone IMEI going out.",
  ...
  ...feature({
    ...
    steps: [
      ...
      "Correct any wrong counts or prices, then save.",
  ...
  ...feature({
    ...
    steps: [
      ...
      "Read Bank, transfer, and POS. It should show the opening banks plus transfer and POS minus money sent to suppliers.",
      "A cashier can still open Money in and out to read People who still owe us.",
    ],
    expect: [
      "Opening cash is on the page for each shop.",
      "Each bank shows its name, account number, shop, and opening balance.",
  ...
  ...feature({
    ...
    what: "Close the day finishes every past Lagos day that had sales, so Sell now can open. You see total sales, cash expected, transfer, POS, and credit left unpaid. If cash came into the till, count it and type cash remitted. If cash expected is zero, click Close the day with no till count. Sell now stays locked until every older day with sales is closed.",
    why: "Abu Twins often sells by transfer and POS for a whole week with no cash. Those days still need a close so tomorrow's sales are not locked, but staff should not be forced to invent a cash count.",
    story: "Monday at Iwo Road had only transfer and POS. Cash expected is ₦0. The cashier opens Close the day, reads the totals, and clicks Close the day. No till count. Sell now opens Tuesday. On Friday a buyer pays cash. Cash expected is ₦50,000. That day needs a till count before close.",
    steps: [
    ...
    expect: [
      "A day with only transfer and POS closes with cash remitted ₦0.",
  ...
  ...feature({
    ...
    steps: [
      ...
      "Read Cash received, Transfer received, and POS received. They add up to Total payments received.",
    ...
    expect: [
      ...
      "Cash plus transfer plus POS equals Total payments received.",
  ...
  ...feature({
    ...
    what: "Shop expenses is for fuel, rent, salary, and light bill. Cashiers can write these too, because the shop is small and the till person often pays the bills. A manager still says yes before money can leave. Tap All expenses, Waiting, or Approved to cut the list. Each row shows when it was asked and, if yes, when it was approved, in Lagos time.",
    why: "If anyone can tap cash for ‘fuel’ with no yes, the till will never match. But locking expenses only to accounts would leave the till person stuck when they already paid fuel.",
    story: "The Challenge cashier pays for fuel, opens Shop expenses, and writes the amount. The request waits on Needs approval. The CEO says yes. Then the pay-out is recorded.",
    steps: [
      "Click Shop expenses.",
    ...
    expect: [
      ...
      "The form says Ask for this shop bill. Categories are Transport, Fuel, Rent, Light bill, Repairs, Salary, Marketing, or Other shop bill.",
  ...
  ...feature({
    title: "10.24 Staff",
    what: "Staff is the people list. Super Admin, the CEO, or a shop manager (if allowed) can add a person, pick their job, and pick their shop. Super Admin or the CEO can lock a login. The CEO cannot lock the main admin.",
    why: "A person who leaves the company must not keep a key to the till.",
    story: "A new cashier starts at Challenge. The CEO adds their work email, sets job to Cashier, sets shop to Challenge, and gives them a first password. After they sign in, the CEO asks them to change it.",
    steps: [
  ...
  ...feature({
    ...
    what: "This page is for the main admin and the CEO. You tick the pages and the work for each job. Super Admin and CEO are not ticked here because they always keep the right to change the shop.",
    why: "The CEO may want the accountant to see money but not Sell now. That should be a tick, not a phone call to Techvaults. The owner also asked that the CEO, not only Super Admin, can make that tick.",
    story: "The CEO asks that cashiers must not see Reports. The CEO opens Who can see what, finds Cashier, unticks Reports, and saves. The cashier signs out and in. Reports is gone. Who did what shows the CEO made that change.",
    steps: [
  ...
  ...feature({
    ...
    steps: [
      ...
      "On Many at once (Excel): pick shop, pick or add the supplier, then upload the PHONES / ACCESSORIES / SCREEN / LAPTOPS file. Do not type a paid amount.",
      "On One phone at a time: scan one IMEI already in your hand with no bill. Fill the item, how it looks, and the supplier. Then press Add phone to shop.",
  ...
  table(
    ...
    [
      ...
      ["39", "Load opening stock from the Abu Twins Excel", "uploader@abutwins.com or Super Admin", "Pick shop. Pick or add a supplier. There is no paid amount. Upload the PHONES / ACCESSORIES / SCREEN / LAPTOPS file. Opening value appears. Phones show In shop. Money in and out does not show a supplier owing."],
      ...
      ["43", "Stock intake phone look and new supplier", "vault@abutwins.com", "How the phone looks offers Brand new, Uk, OPENBOX, Faulty, Non Active. Add new supplier saves to the list. No battery health field."],
      ...
      ["52", "Credit sale remaining balance on the books", "accountant@abutwins.com", "Sell 180,000, take 120,000 transfer. Credit sales shows 60,000. Transfer received shows 120,000. Total payments received includes that 120,000."],
      ["53", "Warranty starts at zero on a sale", "cashier@abutwins.com", "Scan a phone. Warranty shows 0 days. Cashier can pick 7 or 14 days before completing the sale."],
      ["54", "Credit sale with a transfer deposit", "cashier@abutwins.com", "Sell 180,000. Pick Credit sales. Type 120,000 received now. Pick Bank Transfer. Complete sale. Check the books shows Transfer received 120,000 and Credit sales 60,000."],
      ...
      ["56", "Sell now shows how the phone looks", "cashier@abutwins.com", "Scan an In shop IMEI. The line shows storage and Brand new, Uk, OPENBOX, Faulty, or Non Active. After Complete sale the till is empty. Buttons say this sale, not cart."],
