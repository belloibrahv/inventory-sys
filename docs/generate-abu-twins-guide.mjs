...
const children = [
  ...
  new Table({
    ...
    rows: [
      ...
      ["Version", "1.57"],
      ["Status", "Updated: cash till lock stops pay-outs when the till is empty"],
    ].map(([k, v]) =>
      new TableRow({
        children: [
...
h1("5. Words we use"),
  ...
  ...feature({
    what: "Sell now is the till. You scan an IMEI, or type to find by IMEI, phone name, brand, category, storage, or a piece item such as a pouch or charger cord. Phones with IMEI or serial stay one unit each. Piece items show a Pieces box so you sell as many as you have on hand. Each phone line shows storage and How the phone looks under the name. The uploaded initial sell price is the floor (often for wholesale). You may raise it for a walk-in buyer. You cannot go under it unless the CEO or Super Admin overrides. Payment is Cash or Bank only. Bank means the full amount landed in one named bank account from Money in and out. Transfer, POS terminal, and USSD all count as Bank. There is no split payment.",
    why: "Wholesale and walk-in buyers often pay different amounts for the same phone. The shop needs a floor so cashiers cannot quietly undercut the uploaded price, and room to raise the price when a walk-in arrives. Cash is cash. Bank is bank. Staff should not argue about POS versus transfer when the money is the same bank money.",
    story: "Monday at Iwo Road. A wholesaler buys a Camon 30 and pays by bank transfer into GTBank. The cashier picks Bank, then GTBank on Sell now. Later a walk-in pays cash for another phone. The day’s sales record shows cash in the till and bank into GTBank.",
    steps: [
      ...
      "Scan an In shop IMEI, or type a name, brand, category, or IMEI in Find. Add it. Confirm the price starts at the initial sell price.",
      ...
      "Find a pouch or charger cord. Add it. Type how many pieces on this sale.",
    ...
    expect: [
      ...
      "Find matches IMEI, name, brand, category, storage, and piece items.",
  ...
  table(
    ...
    [
      ...
      ["80", "Find on Sell now by name or category", "cashier@abutwins.com", "Type a phone name, brand, category, or storage. Hits show storage and Uk or Brand new. Enter adds the first hit."],
