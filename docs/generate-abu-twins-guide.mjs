...
const children = [
  ...
  new Table({
    ...
    rows: [
      ...
      ["Version", "1.30"],
      ["Status", "Updated: the main admin and the CEO can both correct the shop"],
    ].map(([k, v]) =>
      new TableRow({
        children: [
...
h1("5. Words we use"),
  ...
  ...feature({
    ...
    what: "Upload stock is how phones get onto the shelf. There are three clear doors. Supplier bill lets you add phones one after another, or many lines on one bill, with the supplier and paid or not paid. Many at once (Excel) puts a whole shop on the system from one file as opening stock value. It is not a bill to pay. You can add a new supplier on that screen. One phone at a time is for a single phone in your hand with no bill. A sheet may be up to 25 MB and about 20,000 lines at a time. Split a bigger carton into more than one file. Unpaid supplier bills show as money we still owe. Opening stock never does.",
    why: "Staff were looking for Upload stock and could not find Data Import. They also needed both bulk Excel and one-by-one intake. Small shops need shop managers and goods intake to use both ways, not only the Stock uploader login.",
    story: "Challenge receives part of a Dubai carton. Goods intake opens Upload stock, picks Supplier bill, marks it not paid yet, and scans three iPhone units one after another under the same PO. That evening, Bodija opens Many at once (Excel) and loads the full shop sheet. Sell now works on real shelf units the next morning.",
    steps: [
      ...
      "On Supplier bill: pick the shop, the supplier, and whether it is paid. Add each IMEI or many lines, then save.",
  ...
  table(
    ...
    [
      ...
      ["47", "Upload stock one after another", "vault@abutwins.com or manager@abutwins.com", "Supplier bill accepts one IMEI after another. One phone at a time also works with no bill."],
