...
const children = [
  ...
  new Table({
    ...
    rows: [
      ...
      ["Version", "1.54"],
      ["Status", "Updated: sell pouches and cords by pieces on Sell now"],
    ].map(([k, v]) =>
      new TableRow({
        children: [
...
h1("5. Words we use"),
  ...
  ...feature({
    what: "Sell now is the till. You scan an IMEI, or type to find by IMEI, phone name, brand, category, storage, or a piece item such as a pouch or charger cord. Phones with IMEI or serial stay one unit each. Piece items show a Pieces box so you sell as many as you have on hand. Each phone line shows storage and How the phone looks under the name. You cannot sell under the list sell price unless Super Admin overrides. Selling above the list is allowed, and Amount received updates when you change the price so the day books match.",
    why: "Selling from memory is how phones vanish. Piece items without a quantity box force staff to tap the same cord many times. The till only offers what is In shop, and only after older days with sales are closed.",
    story: "Monday at Iwo Road. A buyer wants three charger cords and one Camon 30. The cashier finds the cord, adds it, types 3 in Pieces, scans the phone IMEI, and finishes. Shop stock drops by three cords and one phone. The invoice shows both lines.",
    steps: [
      ...
      "Scan an In shop IMEI, or type a name, brand, category, or IMEI in Find. Add it. You should see storage and How the phone looks on that line.",
      "Find a pouch or charger cord. Add it. Type how many pieces on this sale. You cannot type more than on hand.",
      "Try a price under the list sell price. Complete sale should refuse unless Super Admin overrides.",
      "Try a price above the list. Amount received should rise with the new total.",
    ...
    expect: [
      ...
      "Pieces cannot go above on hand in this shop.",
      "The scanned line shows storage and How the phone looks from intake.",
      "A price under the list sell price is blocked unless Super Admin overrides.",
      "A price above the list is allowed and Amount received updates.",
  ...
  table(
    ...
    [
      ...
      ["79", "List sell price floor on Sell now", "cashier then Super Admin", "A price under the list sell price is refused for the cashier. Super Admin can override. A price above the list completes and the day’s paid amount matches."],
  ...
  bullet("A sale must stay at or above the list sell price unless Super Admin overrides. Selling above the list is allowed. Amount received updates with the new total."),
