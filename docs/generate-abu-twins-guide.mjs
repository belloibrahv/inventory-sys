...
const children = [
  ...
  new Table({
    ...
    rows: [
      ...
      ["Version", "1.24"],
      ["Status", "Updated: optional cash remit on Close the day, accountant can see every page"],
    ].map(([k, v]) =>
      new TableRow({
        children: [
...
h1("5. Words we use"),
  ...
  ...feature({
    ...
    what: "After a shop is loaded from Excel, Correct and close opening stock is where you count what is really on the shelf. Each line shows its category. Tap Phones, Accessories, Screen, or Laptop to show only that group, so you can give phones to one person and accessories to another. When the count is right, the CEO or main admin closes it. Closed opening stock cannot change.",
  ...
  ...feature({
    ...
    steps: [
      ...
      "On Many at once (Excel): pick shop, supplier, and paid or not paid, then upload the PHONES / ACCESSORIES / SCREEN / LAPTOPS file.",
