...
const children = [
  ...
  new Table({
    ...
    rows: [
      ...
      ["Version", "1.28"],
      ["Status", "Updated: Sell now shows how the phone looks and uses shop words"],
    ].map(([k, v]) =>
      new TableRow({
        children: [
...
h1("5. Words we use"),
  ...
  ...feature({
    ...
    what: "A Swap Deal is when a customer brings an old phone and takes another. You agree a swap value. A manager approves. You give the new phone, collect or pay the difference, and print an invoice. Tap Waiting, Approved, or Done to cut the list. Each card shows when it started or finished in Lagos time.",
  ...
  ...feature({
    title: "10.26 Reports",
    what: "Reports shows sales, money collected from cash plus transfer plus POS, stock value, Swap Deal value, returns, and who still owes, for every completed record you can see. On screen it is a dashboard. Click a box to download those rows. Print or download gives a branded management report. Opening stock is its own value, apart from later unpaid supplier bills. The pack does not change any invoice.",
