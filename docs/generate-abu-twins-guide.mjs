...
const children = [
  ...
  new Table({
    ...
    rows: [
      ...
      ["Version", "1.55"],
      ["Status", "Updated: initial sell price floor with upward flexibility for walk-ins"],
    ].map(([k, v]) =>
      new TableRow({
        children: [
...
h1("5. Words we use"),
  ...
  ...feature({
    what: "Sell now is the till. You scan an IMEI, or type to find by IMEI, phone name, brand, category, storage, or a piece item such as a pouch or charger cord. Phones with IMEI or serial stay one unit each. Piece items show a Pieces box so you sell as many as you have on hand. Each phone line shows storage and How the phone looks under the name. The uploaded initial sell price is the floor (often for wholesale). You may raise it for a walk-in buyer. You cannot go under it unless the CEO or Super Admin overrides. Amount received updates when you change the price, and the invoice keeps what was charged.",
    why: "Wholesale and walk-in buyers often pay different amounts for the same phone. The shop needs a floor so cashiers cannot quietly undercut the uploaded price, and room to raise the price when a walk-in arrives.",
    story: "Monday at Iwo Road. A wholesaler buys a Camon 30 at the initial sell price. Later a walk-in wants the same phone. The cashier raises the price on Sell now. Amount received rises with it. The day’s sales record shows both sales at the prices charged.",
    steps: [
      ...
      "Pick or add a customer when needed. Set the amount paid and the method. Finish.",
    ],
    expect: [
      ...
      "Amount received updates when the price changes. The invoice keeps the charged price.",
