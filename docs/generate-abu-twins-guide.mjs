...
const children = [
  ...
  new Table({
    ...
    rows: [
      ...
      ["Version", "1.34"],
      ["Status", "Updated: unpaid supplier uploads now show on Reports as money owed"],
    ].map(([k, v]) =>
      new TableRow({
        children: [
...
h1("5. Words we use"),
  ...
  ...feature({
    ...
    what: "This page lists money that moved: collections, pay-outs, and the difference. It also lists people who still owe us and what Abu Twins still owes suppliers. Cashiers can open it to follow credit sales. From here you can open Close the day to count the till.",
    why: "Sales pages show goods. This page shows naira. In a small shop the till person also needs to see who still owes payment.",
    story: "The Iwo Road cashier opens Money in & out after lunch. People who still owe us shows three names. They call each one. Later the accountant checks Money in against the transfer alerts.",
    steps: [
      "Sign in as cashier, accountant, or CEO.",
      "Click Money in & out.",
      "Read Money in, Money out, and Difference.",
      "Read People who still owe us.",
      "Read the list of movements.",
    ],
    expect: [
      "A cashier can open Money in & out.",
      "People who still owe us shows credit balances.",
