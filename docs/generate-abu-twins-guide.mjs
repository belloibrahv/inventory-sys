...
const children = [
  ...
  new Table({
    ...
    rows: [
      ...
      ["Version", "1.53"],
      ["Status", "Updated: sales returns, list sell price floor, till find and phone details"],
    ].map(([k, v]) =>
      new TableRow({
        children: [
...
h1("5. Words we use"),
  ...
  ...feature({
    what: "Sell now is the till. You scan an IMEI, or type to find by IMEI, phone name, brand, category, storage, or accessory. Each line shows storage and How the phone looks (Brand new, Uk, OPENBOX) under the name. You cannot sell under the list sell price unless Super Admin overrides. Selling above the list is allowed, and Amount received updates when you change the price so the day books match. Credit sales can still take a deposit today. The system then makes an invoice and clears the till for the next buyer. A USB scanner works like a keyboard: scan, then Enter. If yesterday had sales and nobody closed that day, Complete sale stays locked until the till is counted. If the line drops and the till is not locked, the sale stays on this device as a parked sale and posts when the line returns.",
    why: "Selling from memory is how phones vanish. Selling under the list sell price without Super Admin is how margin vanishes. The till only offers what is In shop, and only after older days with sales are closed.",
    story: "Monday at Iwo Road. Sunday had cash sales and nobody closed. The cashier opens Sell now. A red note says the shop has not closed 6 September. Complete sale is locked. They open Close the day, count the drawer, and close Sunday. Sell now opens. A buyer wants a Camon 30. They type Camon in Find, pick the phone, see 128GB · Uk under the name, collect transfer and finish. Later they raise the price above the list. Amount received rises with it. The day’s sales record matches.",
    steps: [
    ...
    expect: [
      ...
      "Find matches IMEI, name, brand, category, and storage.",
