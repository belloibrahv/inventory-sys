...
const children = [
  ...
  new Table({
    ...
    rows: [
      ...
      ["Version", "1.37"],
      ["Status", "Updated: send phones back to a supplier by IMEI only, in bulk, and move the house account"],
    ].map(([k, v]) =>
      new TableRow({
        children: [
...
h1("5. Words we use"),
  ...
  table(
    ...
    [
      ...
      ["They owe us", "A surplus on a supplier after send-backs. We do not owe that house. That house owes Abu Twins."],
  ...
  bullet("Sign out from your name. The next screen is Sign in. A half-built shop page in between is a fault."),
