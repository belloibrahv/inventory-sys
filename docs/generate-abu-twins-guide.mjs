...
const children = [
  ...
  new Table({
    ...
    rows: [
      ...
      ["Version", "1.52"],
      ["Status", "Updated: all-shop auditor login; only the CEO can permanently remove"],
    ].map(([k, v]) =>
      new TableRow({
        children: [
...
h1("5. Words we use"),
  ...
  ...feature({
    ...
    steps: [
      ...
      "Scan an In shop IMEI, or type it and press Enter. Add it. You should see storage and How the phone looks on that line. Warranty days start at 0. Type the days of cover if the buyer needs them.",
      "Try to scan a phone that is Faulty. Sell now should refuse it.",
    ...
    expect: [
      ...
      "Warranty days start at 0. The cashier can type the days on that line before Complete sale.",
      "A Damaged phone is refused on Sell now until someone sets Good (sellable).",
