...
h1("5. Words we use"),
  ...
  table(
    ...
    [
      ...
      ["70", "Change or remove stock on the price list", "uploader@abutwins.com or Super Admin", "On Phones & items, click Change or remove on a cord. Reduce stock by pieces. On a phone, Reduce stock asks for IMEI lines. Remove item hides a used name or deletes an unused one."],
