...
const children = [
  ...
  new Table({
    ...
    rows: [
      ...
      ["Version", "1.15"],
      ["Status", "Updated: Three shops, separate shop records, and a shop-by-shop view for head office"],
    ].map(([k, v]) =>
      new TableRow({
        children: [
...
h1("5. Words we use"),
  ...
  table(
    ...
    [
      ...
      ["Shop manager", "The manager at Iwo Road, Bodija, or Challenge", "Run one shop. Sell, receive, transfer, approve shop work. Sees only that shop."],
  ...
  body("There are nineteen practice logins: four at head office and five in each of the three shops. That is every job, in every shop, so any workflow in this book can be tried by the person who would really do it."),
