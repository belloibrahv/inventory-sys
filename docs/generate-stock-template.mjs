...
const readMe = [
  ...
  ["Prepared by Techvaults Limited  ·  techvaults.com  ·  8 September 2026"],
  [""],
  ["What this file is"],
  ["Fill this workbook with what is on the shelf tonight at Iwo Road and Challenge. Send the filled file back. We load it so staff can sell and you can test the real workflows."],
  [""],
  ["How to fill it"],
  ...
  ["2. Use the exact shop names: Iwo Road, Ibadan    and    Challenge, Ibadan"],
  ...
  [""],
  ["When you are done"],
  ["Save this Excel. Send it back to Techvaults with the message that Iwo Road and Challenge were counted tonight. We will load names, IMEIs, and piece counts, then tell you when Sell now is ready."],
]

const items = [
  ["row_type", "item_code", "name", "brand", "category", "tracking", "condition", "color", "storage", "ram", "cost", "lowest_price", "selling_price", "warranty_days", "description"],
...
const phones = [
  ...
  ["SAMPLE", "Challenge, Ibadan", "S24-256-GRY", "Galaxy S24 256GB", "990000033333333", "", "", "Brand new", "A", "100", "", "This phone sits at Challenge, not Iwo Road."],
  ...
  ["REAL", "Iwo Road, Ibadan", "", "", "", "", "", "", "", "", "", "Add one row per phone or serial item on the shelf. Shop must be Iwo Road, Ibadan or Challenge, Ibadan."],
]

const pieces = [
  ["row_type", "shop", "item_code", "name", "pieces_on_shelf", "notes"],
  ["SAMPLE", "Iwo Road, Ibadan", "CORD-TYPEC", "Type-C charger cord", "20", "Delete this sample. Count the drawer tonight."],
  ["SAMPLE", "Challenge, Ibadan", "CORD-TYPEC", "Type-C charger cord", "8", "Same item, different shop, different count."],
  ["REAL", "Iwo Road, Ibadan", "", "", "", "One row per no-number item per shop. tracking on Items must be NONE."],
]
...
const staff = [
  ...
  ["SAMPLE", "SAMPLE Accountant", "accounts@example.com", "Accountant", "", "Leave shop empty if this person sees both shops."],
...
const coming = [
  ...
  ["REAL", "Iwo Road, Ibadan", "", "", "", "", "", "", "", "", "Only goods that have not arrived. Phones already in the drawer go on Phones in shop instead."],
]

const words = [
  ["What to type", "Allowed value", "Where it is used"],
  ["Shop", "Iwo Road, Ibadan", "Phones in shop, Pieces in shop, Staff, Coming goods"],
  ["Shop", "Challenge, Ibadan", "Phones in shop, Pieces in shop, Staff, Coming goods"],
  ...
  ["row_type", "SAMPLE", "Every data tab. Delete these rows before you send, or we will ignore them."],
