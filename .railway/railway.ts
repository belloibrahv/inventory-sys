...
export default defineRailway(() => {
  const web = service("inventory-sys", {
    ...
    start: "node scripts/use-postgres-schema.mjs && npx prisma generate && npx tsx scripts/heal-day-closes.ts && npx prisma db push && npx tsx prisma/seed-users.ts && npm start",
    healthcheck: "/login",
