...
export const VIEW_PERMS = [
  ...
  { key: "view.neighbor-fills", label: "Buy from next door", href: "/neighbor-fills" },
  ...
  { key: "view.approvals", label: "Waiting for yes", href: "/approvals" },
...
export const ACTION_PERMS = [
  ...
  { key: "action.upload", label: "Load the item list and stock from a sheet" },
  ...
  { key: "action.neighbor", label: "Record goods collected from a neighboring shop" },
  { key: "action.return", label: "Record returns" },
  { key: "action.swap", label: "Record swaps" },
  { key: "action.repair", label: "Do repair work" },
  { key: "action.recon", label: "Count stock" },
  { key: "action.approve", label: "Say yes or no to requests" },
  ...
  { key: "action.override_floor", label: "Sell under the lowest price" },
] as const
