...
const RECORD_KINDS: Record<string, string> = {
  ...
  StockTransfer: "Shop to shop (Stock Transfer)",
  NeighborFill: "Stock Outsourcing (Neighbour shop fill)",
  ParkedSale: "Waiting sale",
  AuditLog: "Who did what",
  RolePermission: "Who can see what",
  LedgerEntry: "Customer money record",
...
const CHANGE_KEYS: Record<string, string> = {
  ...
  neighborName: "Neighbor shop",
  neighborFill: "Stock Outsourcing (Neighbour shop fill)",
  payRef: "Payment number",
  goodsUnchanged: "Goods unchanged",
  itemsUntouched: "Invoice lines unchanged",
  passwordChanged: "Password changed",
  result: "Result",
  queuedAt: "Waiting since",
  created: "Added",
  skipped: "Skipped",
  ...
  expectedCash: "Cash received",
  countedCash: "Cash remitted",
  cosmeticGrade: "How the phone looks",
  batteryHealth: "Battery health",
  sku: "Item code",
  sellingPrice: "Selling price",
  transfer: "Shop to shop list",
  count: "Count",
  updated: "Changed",
  names: "Item names",
  reason: "Reason",
...
const RESULT_WORDS: Record<string, string> = {
  ok: "Done",
  denied: "Not allowed",
  vanished: "A waiting sale left this phone without posting",
  sitting: "A waiting sale sat too long",
  unknown: "That login is not on the books",
  bad_password: "Email or password is not correct",
