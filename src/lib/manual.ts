...
> = [
  ...
  },
  {
    ...
    doThis: [
      ...
      "Scan or type the IMEI. That only fills the number. Fill the item, how it looks, and the supplier, then press Add phone to shop.",
  ...
  },
  {
    ...
    title: "Sell now",
    needAction: "action.sell",
    what: "The till. Scan or type an In shop IMEI or an accessory name, pick the buyer, take cash, transfer, POS, or credit, and finish. On credit sales you can still type money received now and say if it was cash, transfer, or POS. What is left is credit sales. The system makes an invoice.",
    doThis: [
      ...
      "For a full payment, pick cash, transfer, or POS and finish.",
      "For a part payment, pick Credit sales, type the amount received now, and pick how they paid it. The rest stays as credit sales.",
  ...
  },
  {
    ...
    lookup: ["purchase", "supplier bill", "expected", "china", "dubai", "send back", "missing", "sold today", "upload stock", "PO"],
  },
  {
    id: "customers",
    href: "/customers",
  ...
  },
  {
    ...
    href: "/suppliers",
    title: "Suppliers",
    what: "People and firms Abu Twins buys cartons from. Keep the country and city so expected goods have an origin. Neighboring dealers you fill from can be marked Neighboring shop. Click a box at the top to see the houses behind that number. Click a house to drop down its bills.",
    doThis: [
      "Click a box at the top to see the houses that make that number. We still owe shows only houses with a balance.",
      "Click a house name to drop down its bills, with bought, paid, and still owed. Copies of the same name sit under that one house.",
    ...
    lookup: ["supplier", "creditor", "country", "dubai", "china", "house", "click the box", "still owe"],
  },
  {
    id: "transfers",
    href: "/transfers",
  ...
  },
  {
    ...
    doThis: [
      ...
      "If a manager must say yes, wait on Waiting for yes.",
  ...
  },
  {
    ...
    what: "A customer brings an old phone and takes another. You agree a swap value. A manager approves. You collect or pay the difference and print an invoice.",
    doThis: [
    ...
    lookup: ["swap", "trade-in", "trade", "swap deal"],
  },
  {
    id: "repairs",
    href: "/repairs",
  ...
  },
  {
    ...
    what: "Money that moved: collections, pay-outs, and the difference. It also lists people who still owe us and what Abu Twins still owes suppliers. Cashiers can open this list to call credit buyers.",
    doThis: [
  ...
  },
  {
    ...
    what: "The money paper for one shop, for one day or a stretch of days. Total payments received is cash plus transfer plus POS from the payment lines. Credit sales is what is still owed on those invoices, not the full invoice. Opening stock is not in this money paper as a payable. This paper does not change any sale.",
    doThis: [
      ...
      "Read Cash received, Transfer received, and POS received. They must add up to Total payments received.",
