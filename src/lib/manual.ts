...
> = [
  ...
  },
  {
    ...
    watch: [
      ...
      "Unpaid upload bills appear on Finance as still owed. Accounts settle them with Pay the supplier.",
  ...
  },
  {
    ...
    what: "The money paper for one shop, for one day or a stretch of days. Open a day that has passed, put it beside another stretch of days, then print it or download it. This paper does not change any sale.",
    doThis: [
      ...
      "Read what the books say, this time against last time, how the money adds up, and the checks.",
      "Download the PDF or the CSV, or print it and save it as a PDF.",
    ],
    watch: [
