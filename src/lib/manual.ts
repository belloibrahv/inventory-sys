...
> = [
  ...
  },
  {
    ...
    href: "/suppliers",
    title: "Suppliers",
    what: "People and firms Abu Twins buys cartons from. Keep the country and city so expected goods have an origin. Neighboring dealers you fill from can be marked Neighboring shop. Click a box at the top to see the houses behind that number. Click a house to drop down its bills. They owe us is the surplus after phones were sent back.",
    doThis: [
      "Click a box at the top to see the houses that make that number. We still owe shows houses we have not paid. They owe us shows houses with a surplus after send-backs.",
      "Click a house name to drop down its bills, with bought, paid, sent back, and the balance. Copies of the same name sit under that one house.",
    ...
    lookup: ["supplier", "creditor", "country", "dubai", "china", "house", "click the box", "still owe", "they owe us", "send back"],
  },
  {
    id: "transfers",
    href: "/transfers",
