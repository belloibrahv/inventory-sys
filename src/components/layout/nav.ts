...
export const navGroups: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Trade-In & Exchange", href: "/swaps", icon: Repeat2 },
  ...
  },
  {
    ...
    items: [
      { name: "Cash Flow & Ledger", href: "/finance", icon: Wallet },
      { name: "Financial Audit Pack", href: "/audit/books", icon: Scale },
      { name: "Profitability (P&L)", href: "/profits", icon: TrendingUp },
      { name: "Operating Expenses", href: "/expenses", icon: Receipt },
